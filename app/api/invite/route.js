...
export async function POST(req,res){
    ...
    if (data.partner){
        await resend.emails.send({
            ...
            to: data.email,
            subject: 'Drip Invite',
            html: `<p>Hey ${data.name}, ${data.partner} has invited you to <a href="https://newdrip.vercel.app/questions/${data.email}">Drip</a>!</p>`,
        });
    }else{
        await resend.emails.send({
            from: 'onboarding@dripsoftly.com',
            to: data.email,
            subject: 'Drip Invite',
            html: `<p>Hey ${data.name}, here is your link to join <a href="https://newdrip.vercel.app/questions/${data.email}">Drip</a>!</p>`,
        });
    }
