...
export default function questions(){
    ...
    return (
        ...
        <div className="flex justify-center gap-4">
            ...
            {questionNumber===4?<a className="bg-primary text-white h-12 w-48 rounded-lg hover:scale-110 flex items-center justify-center transition-transform duration-300 hover:cursor-pointer" href="/invite">Invite</a>:null}
        </div>
        </div>
    )
}
